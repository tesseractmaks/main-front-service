...
export async function getListProfiles(page = 1, params = {}) {
  let response = await fetch(`http://194.58.121.63:3000/api/v1/profiles/`);
...
export async function getRelatedProperties() {
  let response = await fetch(`http://194.58.121.63:3000/api/v1/properties/sidebar`);
...
export async function getOneUser(idNum) {
  let response = await fetch(`http://194.58.121.63:3000/api/v1/users/${idNum}/`);
  const userData = await response.json();
  return userData
};

export async function getOneProfile(idNum) {
  let response = await fetch(`http://194.58.121.63:3000/api/v1/profiles/${idNum}/`,
  {
...
export async function getOneProfileByUser(idNum) {
  let response = await fetch(`http://194.58.121.63:3000/api/v1/profiles/user_id?user_id=${idNum}`,
  {
    // credentials: "same-origin"
...
export async function deleteOneProfile(idNum) {
  ...
  // await fetch(`http://194.58.121.63:3000/api/v1/profiles/${idNum}/`, {
  await fetch(`http://194.58.121.63:3000/api/v1/users/${idNum}/`, {
    method: "DELETE",
  });
};
