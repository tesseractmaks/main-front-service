...
export async function mainMenu() {
    ...
    let  ws = new WebSocket("wss:api-chat.tesseractmaks.tech/api/v1/chat/ws/1")
...
async function chatForm() {
    ...
    <form action=""class="form-container" id="cht-form">\
        ...
        <label for="msg"></label>\
        <textarea placeholder="Введите сообщение.." name="msg" value="" required class="area-ch-x"></textarea>\
